...
Прошивка bootloader доступна в меню действий строки и в меню общих действий
для выбранных устройств. Она доступна для любой распознанной модели в состоянии
основного приложения, если в каталоге этой модели
