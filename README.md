...
В графическом окне CLI доступны две кнопки: чистый перевыпуск обеих редакций
приложения и перевыпуск приложений вместе с установщиками. Те же операции доступны
из командной строки:
...
Обе операции всегда обрабатывают внутреннюю и внешнюю редакции. Команда
`installer` сначала пересобирает приложения; `--dry-run` показывает
