...
Во внутренней редакции, если модель устройства известна, но установленная версия
не распознана по `descriptionRegex`, интерфейс предлагает все доступные для этой
модели прошивки. Для известной версии учитывается граф `transitions`.
