...
| `type`, `version` | Тип и версия основного приложения в шестнадцатеричном виде |
| `bootloaderType`, `bootloaderVersion` | Тип и версия устройства в загрузчике |
